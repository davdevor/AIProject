...
r = requests.get("https://od-api.oxforddictionaries.com:443/api/v1/wordlist/en/lexicalCategory%3DPreposition", headers = {'app_id': app_id, 'app_key': app_key})
jsonfile = open('prepositions.json','w')
json.dump(r.json(),jsonfile)
jsonfile.close()
